...
import image from '../../assets/project1.svg'
        ...
        <Card>
            <div className="aboutme_card">
                  ...
                  <div className="aboutme_card-text">
                        ...
                        <Text text="Aluna da ciclo formativo da PretaLab, 25 anos, do Rio de Janeiro. Sou uma tecnologista entusiasmada, dando os primeiros passos na jornada de desenvolvimento de software." />
                  </div>
            </div>
      </Card>
